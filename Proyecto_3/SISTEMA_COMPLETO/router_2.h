...
struct Router2: sc_module{

    tlm_utils::simple_initiator_socket<Router2> socket_initiator_A;
    tlm_utils::simple_target_socket<Router2>    socket_target_A;

    tlm_utils::simple_initiator_socket<Router2> socket_initiator_B;
    tlm_utils::simple_target_socket<Router2>    socket_target_B;

    tlm_utils::simple_initiator_socket<Router2> socket_initiator_E;
    tlm_utils::simple_target_socket<Router2>    socket_target_E;
        ...
        socket_target_E("socket_target_E")
    {
        ...
        socket_initiator_A.register_nb_transport_bw(this, &Router2::nb_transport_bw_A);
        socket_target_A.register_nb_transport_fw(this, &Router2::nb_transport_fw_A);

        socket_initiator_B.register_nb_transport_bw(this, &Router2::nb_transport_bw_B);
        socket_target_B.register_nb_transport_fw(this, &Router2::nb_transport_fw_B);

        socket_initiator_E.register_nb_transport_bw(this, &Router2::nb_transport_bw_E);
        socket_target_E.register_nb_transport_fw(this, &Router2::nb_transport_fw_E);
